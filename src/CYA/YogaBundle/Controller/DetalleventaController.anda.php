...
class DetalleventaController extends Controller
{
    public function addAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) 
        {
            ...
            $detalleventa->setPrecioproducto($precioproducto *  $preciototal);             
           
            $em = $this->getDoctrine()->getManager();
            $em->persist($detalleventa);
            $em->flush(); 
            $successMessage = 'Producto agregado: '.$nombreproducto. ", Precio Unitario:  ".$precioproducto. ", Cantidad: ".$cantidad.", Precio Total:  ".$preciototal ;
       ...
       /* $saldo = 0;  
        ...
        $detalleventa, $request->query->getInt('page' , 1),
        10
        );
*/
        ...
        return $this->render('CYAYogaBundle:Detalleventa:add.html.twig', array('form' => $form->createView(), 'productos' => $productos));
